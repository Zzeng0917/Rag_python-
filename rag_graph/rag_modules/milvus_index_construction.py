...
class MilvusIndexConstructionModule:
    ...
    def _create_collection_schema(self) -> CollectionSchema:
        ...
        fields = [
            ...
            FieldSchema(name="city_id", dtype=DataType.VARCHAR, max_length=100),
            FieldSchema(name="category", dtype=DataType.VARCHAR, max_length=200),
            FieldSchema(name="location", dtype=DataType.VARCHAR, max_length=300),
        ...
        try:
            ...
            for i, (chunk, vector) in enumerate(zip(chunks, vectors)):
                entity = {
                    ...
                    "entity_name": self._safe_truncate(chunk.metadata.get("entity_name", ""), 300),
                    "node_type": self._safe_truncate(chunk.metadata.get("node_type", ""), 100),
                    "city_id": self._safe_truncate(chunk.metadata.get("city_id", ""), 100),
                    "category": self._safe_truncate(chunk.metadata.get("category", ""), 200),
                    "location": self._safe_truncate(chunk.metadata.get("location", ""), 300),
        ...
        try:
            ...
            search_kwargs = {
                ...
                "output_fields": ["text", "node_id", "entity_name", "node_type", 
                                "city_id", "category", "location", "doc_type",
                                "chunk_id", "parent_id"],
